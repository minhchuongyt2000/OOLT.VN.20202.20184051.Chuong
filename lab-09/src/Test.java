...
public class Test {
    public static void main(String[] args) {
        ...
        input.setBounds(100, 100, 200, 30);
            ...
            public void actionPerformed(ActionEvent e) {
                switch(input.getText()) {
                    ...
                    case "2":
                        ...
                        btnOption2MiniFrame1.setBounds(500, 200, 50, 50);
